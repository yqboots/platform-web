...
import {CardedFullWidthTabbed1Component} from '@showcase/ui/page-layouts/carded/full-width-tabbed-1/full-width-tabbed-1.component';
import {CardedFullWidthTabbed2Component} from '@showcase/ui/page-layouts/carded/full-width-tabbed-2/full-width-tabbed-2.component';
import {CardedLeftSidebar1Component} from '@showcase/ui/page-layouts/carded/left-sidebar-1/left-sidebar-1.component';
import {CardedLeftSidebar2Component} from '@showcase/ui/page-layouts/carded/left-sidebar-2/left-sidebar-2.component';
import {CardedLeftSidebarTabbed1Component} from '@showcase/ui/page-layouts/carded/left-sidebar-tabbed-1/left-sidebar-tabbed-1.component';
import {CardedLeftSidebarTabbed2Component} from '@showcase/ui/page-layouts/carded/left-sidebar-tabbed-2/left-sidebar-tabbed-2.component';
import {CardedRightSidebar1Component} from '@showcase/ui/page-layouts/carded/right-sidebar-1/right-sidebar-1.component';
import {CardedRightSidebar2Component} from '@showcase/ui/page-layouts/carded/right-sidebar-2/right-sidebar-2.component';
import {CardedRightSidebarTabbed1Component} from '@showcase/ui/page-layouts/carded/right-sidebar-tabbed-1/right-sidebar-tabbed-1.component';
import {CardedRightSidebarTabbed2Component} from '@showcase/ui/page-layouts/carded/right-sidebar-tabbed-2/right-sidebar-tabbed-2.component';
import {SimpleFullWidth1Component} from '@showcase/ui/page-layouts/simple/full-width-1/full-width-1.component';
import {SimpleFullWidthTabbed1Component} from '@showcase/ui/page-layouts/simple/full-width-tabbed-1/full-width-tabbed-1.component';
import {SimpleLeftSidebar1Component} from '@showcase/ui/page-layouts/simple/left-sidebar-1/left-sidebar-1.component';
import {SimpleLeftSidebar2Component} from '@showcase/ui/page-layouts/simple/left-sidebar-2/left-sidebar-2.component';
import {SimpleLeftSidebar3Component} from '@showcase/ui/page-layouts/simple/left-sidebar-3/left-sidebar-3.component';
import {SimpleLeftSidebar4Component} from '@showcase/ui/page-layouts/simple/left-sidebar-4/left-sidebar-4.component';
import {SimpleRightSidebar1Component} from '@showcase/ui/page-layouts/simple/right-sidebar-1/right-sidebar-1.component';
import {SimpleRightSidebar2Component} from '@showcase/ui/page-layouts/simple/right-sidebar-2/right-sidebar-2.component';
import {SimpleRightSidebar3Component} from '@showcase/ui/page-layouts/simple/right-sidebar-3/right-sidebar-3.component';
