...
import {CalendarEventModel} from '@yq/extensions/calendar/event.model';
...
export class CalendarComponent implements OnInit {
    ...
    confirmDialogRef: MatDialogRef<YqConfirmDialogComponent>;
    dialogRef: any;
    ...
    deleteEvent(event): void {
        this.confirmDialogRef = this._matDialog.open(YqConfirmDialogComponent, {
            disableClose: false
        });
