...
import {Mail} from '@yq/extensions/mail-ngrx/mail.model';
import {MailNgrxService} from '@yq/extensions/mail-ngrx/mail.service';
import * as fromStore from '@yq/extensions/mail-ngrx/store';

import {locale as english} from '@yq/extensions/mail-ngrx/i18n/en';
import {locale as chinese} from '@yq/extensions/mail-ngrx/i18n/zh';
