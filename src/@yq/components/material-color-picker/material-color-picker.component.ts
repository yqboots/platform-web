...
import {yqAnimations, MatColors} from '@yq/core';

export const YQBoots_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR: any = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => YqMaterialColorPickerComponent),
    multi: true
};

@Component({
    selector: 'yq-material-color-picker',
    templateUrl: './material-color-picker.component.html',
    styleUrls: ['./material-color-picker.component.scss'],
    animations: yqAnimations,
    encapsulation: ViewEncapsulation.None,
    providers: [YQBoots_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR]
})
export class YqMaterialColorPickerComponent implements ControlValueAccessor {
    colors: any;
    hues: string[];
    view: string;
    selectedColor: any;
    ...
    set color(value) {
        ...
        // Split the color value (red-400, blue-500, yq-navy-700 etc.)
