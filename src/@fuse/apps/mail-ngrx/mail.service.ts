...
import {MailAppState} from '@fuse/apps/mail-ngrx/store/reducers';
import {getFiltersArr, getFoldersArr, getLabelsArr, getMailsArr} from '@fuse/apps/mail-ngrx/store/selectors';
