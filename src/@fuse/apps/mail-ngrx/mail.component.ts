...
import {Mail} from '@fuse/apps/mail-ngrx/mail.model';
import {MailNgrxService} from '@fuse/apps/mail-ngrx/mail.service';
import * as fromStore from '@fuse/apps/mail-ngrx/store';

import {locale as english} from '@fuse/apps/mail-ngrx/i18n/en';
import {locale as turkish} from '@fuse/apps/mail-ngrx/i18n/tr';
