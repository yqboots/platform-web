...
} from 'assets/angular-material-examples/dialog-content/dialog-content-example';
import {
    DialogDataExample,
    DialogDataExampleDialog
} from 'assets/angular-material-examples/dialog-data/dialog-data-example';
import {
    DialogElementsExample,
    DialogElementsExampleDialog
} from 'assets/angular-material-examples/dialog-elements/dialog-elements-example';
import {
    DialogOverviewExample,
    DialogOverviewExampleDialog
} from 'assets/angular-material-examples/dialog-overview/dialog-overview-example';
...
import {
    ...
    MyTelInput
} from 'assets/angular-material-examples/form-field-custom-control/form-field-custom-control-example';
...
} from 'assets/angular-material-examples/snack-bar-component/snack-bar-component-example';
...
} from 'assets/angular-material-examples/bottom-sheet-overview/bottom-sheet-overview-example';
...
import {
    ...
    ExampleHeader
} from 'assets/angular-material-examples/datepicker-custom-header/datepicker-custom-header-example';
...
} from 'assets/angular-material-examples/table-simple-column/table-simple-column-example';
