...
export class YqSidebarComponent implements OnInit, OnDestroy {
  // Name
  @Input()
  name: string;
  ...
  ngOnInit(): void {
    ...
    this._yqConfigService.config
      ...
      .subscribe((config) => {
        this._yqConfig = config;
      });

    // Register the sidebar
    this._yqSidebarService.register(this.name, this);
  ...
  ngOnDestroy(): void {
    ...
    this._yqSidebarService.unregister(this.name);
  ...
  private _showBackdrop(): void {
    ...
    this._backdrop.classList.add('yq-sidebar-overlay');

    // Add a class depending on the invisibleOverlay option
    if (this.invisibleOverlay) {
      this._backdrop.classList.add('yq-sidebar-overlay-invisible');
    }
  ...
  /**
   * Change some properties of the sidebar and make it visible
   */
  ...
  /**
   * Change some properties of the sidebar and make it invisible
   */
