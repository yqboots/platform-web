...
export class AcademyCourseComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  constructor(private _academyCourseService: AcademyCourseService,
  ...
  ngAfterViewInit(): void {
    this.courseStepContent = this.scrollbarDirectives.find((yqScrollbarDirective) => {
      return yqScrollbarDirective.elementRef.nativeElement.id === 'course-step-content';
    });
  }
