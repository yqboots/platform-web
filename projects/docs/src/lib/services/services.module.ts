...
import {YqConfigServiceDocsComponent} from './yq-config/yq-config.component';
import {YqSplashScreenServiceDocsComponent} from './yq-splash-screen/yq-splash-screen.component';
